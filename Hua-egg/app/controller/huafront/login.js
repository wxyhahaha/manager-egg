...
class LoginController extends Controller {
  async login() {
    ...
    try{
      ...
      password = await ctx.helper.md5Password(password,privateKey)
      ...
      if(user.isPass){
       ...
       return ctx.body = { code:0, msg:'login success', data:{ user:user.user, newtoken:signData }}
      }
      else{ 
